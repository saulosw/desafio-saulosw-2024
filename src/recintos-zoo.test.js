...
describe('Recintos do Zoologico', () => {
    ...
    test('Deve encontrar recinto compatível para 1 gazela', () => {
    ...
    test('Deve encontrar recinto compatível para 1 hipopotamo', () => {
    ...
    test('Deve encontrar recinto compatível para 2 leão', () => {
    ...
    test('Deve rejeitar recinto quando há carnívoro de espécie diferente', () => {
        const resultado = new RecintosZoo().analisaRecintos('LEOPARDO', 1);
        expect(resultado.erro).toBe("Não há recinto viável");
        expect(resultado.recintosViaveis).toBeFalsy();
    });
    
    test('Deve encontrar recinto compatível para 1 macaco', () => {
    ...
    test('Deve encontrar recinto compatível para 2 crocodilos', () => {
    ...
    test('Deve encontrar recinto compatível para 2 gazelas', () => {
